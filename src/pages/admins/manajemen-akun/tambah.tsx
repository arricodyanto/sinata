...
export default function TambahDataAkun({ error }: any) {
	...
	const handleTambah = async (form: any) => {
		...
		if (!isEmpty) {
			if (form.username === '' || form.email === '' || form.password === '') {
				toast.warning(
					'Harap masukkan username, alamat email, dan kata sandi Anda.',
					{
						theme: 'colored',
					},
				);
	...
	return (
		<Box className='bg-grey'>
			...
			<DashboardPanel listMenu={listMenuAdmin}>
				<HeaderBreadcrumbs
					pageHeader='Tambahkan Data Akun'
					currentPage='Tambah Data'>
					<Link
						href='/admins/manajemen-akun'
