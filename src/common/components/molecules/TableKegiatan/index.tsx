...
import { deleteOneDataKegiatan, getAllDataKegiatan, getAllDataKegiatanUser, updateOneDataKegiatan } from '@/services/data-kegiatan';
import CancelIcon from '@mui/icons-material/Cancel';
import CloseIcon from '@mui/icons-material/Close';
import DeleteIcon from '@mui/icons-material/Delete';
import EditRoundedIcon from '@mui/icons-material/EditRounded';
import SaveIcon from '@mui/icons-material/Save';
import { Box, Button, Fade, FormControl, FormLabel, IconButton, MenuItem, Modal, Stack, Typography } from '@mui/material';
        ...
        <>
            {data.length === 0 ? (
                <TableDataEmpty headers={tableHeaders}
                    addButton={
                        <Link href={admin ? '/admins/daftar-kegiatan/tambah' : '/users/tambah-kegiatan'}>
